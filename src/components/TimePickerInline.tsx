      ...
      <div className="inline-flex items-center gap-2 bg-white px-3 py-2 rounded-lg border border-gray-200">
        ...
        <div className="flex items-center gap-0.5">
          <button
            ...
            className="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded transition-colors duration-200 flex-shrink-0"
          ...
          <input
            ...
            placeholder="--"
            className={`w-9 text-center text-sm font-medium ${hasValue ? 'text-gray-900' : 'text-gray-400'} bg-transparent border-none outline-none tabular-nums`}
          />
          <button
            type="button"
